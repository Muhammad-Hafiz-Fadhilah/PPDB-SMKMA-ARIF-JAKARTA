...
.h11{
 ...
 <table width="700" border="0" class="heading">
   <tr class="heading">
     ...
     <td width="64%" align="center" class="heading"><h1 class="h11"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 18px">LAPORAN CALON SISWA YANG LULUS JURUSAN MANAJEMEN PERKANTORAN DAN LAYANAN BISNIS</span></h1>
